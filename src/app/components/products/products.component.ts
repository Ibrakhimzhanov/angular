...
export class ProductsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.basketSubscription = this.productService.getProductFromBasket()
            .subscribe(data => {
                this.basket = data
            })    }
    ...
    openDialog(product?: IProducts): void {
        ...
        dialogRef.afterClosed().subscribe(data => {
            if (data) {
                (data && data.id) ? this.updateData(data) :  this.postData(data);
            }
        })
    };
        ...
        updateToBasket(product: IProducts) {
            product.quantity += 1;
            this.productService.updateProductToBasket(product)
                .subscribe(data => {
